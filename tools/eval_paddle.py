...
from utils.function_paddle import testval, test
from utils.utils_paddle import create_logger
...
def main():
    ...
    # build model
    model = models.pidnet_paddle.get_seg_model(config, imgnet_pretrained=True)
    ...
    if config.TEST.MODEL_FILE:
        ...
        model_state_file = os.path.join(final_output_dir, 'best.pdparams')      
   
    logger.info('=> loading model from {}'.format(model_state_file))
        
    pretrained_dict = paddle.load(model_state_file)
